...
export function FinalCTA() {
  return (
    <section id="CTA" className="py-16 lg:py-24" aria-labelledby="final-cta">
      <div className="site-content min-w-0">
        <div className="final-cta-panel">
          ...
          <div className="mt-10 grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-6 lg:gap-10">
            ...
            <div className="final-cta-path final-cta-path--divider">
              ...
              <Link to="/contact#partnerships" className="mt-5 inline-flex">
                <Button
                  variant="outline"
                  className="epineon-btn-secondary rounded-full px-8 py-4 text-base"
                >
                  Partner with us
                </Button>
              </Link>
